...
plt.suptitle('Distribution of Genre for all unique books from 2009 to 2019', fontsize=20)
plt.show()

#visualize the above insights according to each year
...
plt.suptitle('Distribution of Fiction and Non-Fiction books for every year from 2009 to 2019',
             fontsize=25)
plt.legend(g_count.index, loc='center right', fontsize=12)
plt.show()

#top 10 bestselling authors of both fiction and non-fiction categories
...
#Their unique posts and overall reviews
n_best = 20
